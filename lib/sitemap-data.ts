// =============================================================================
// SITEMAP DATA - CLÍNICAS FERTILIDAD
// =============================================================================
// Reproducción asistida en España - 8118 municipalities
// =============================================================================
...
// =============================================================================
// HIGH-INTENT KEYWORD MODIFIERS - Sector Fertilidad
// =============================================================================
export const MODIFIERS = [
  "",
  // ============ PRECIO ============
  "-precios", "-economica", "-barata", "-cuanto-cuesta",
  "-financiacion", "-seguridad-social",
  
  // ============ CALIDAD ============
  "-mejor", "-recomendada", "-especializada", "-prestigiosa",
  "-alta-tasa-exito",
  
  // ============ EDAD ============
  "-mayores-40", "-mayores-45", "-edad-avanzada",
  
  // ============ TIPO TRATAMIENTO ============
  "-garantizada", "-sin-exito-no-pago", "-primera-consulta-gratis",
  
  // ============ UBICACIÓN ============
  "-cerca-de-mi", "-centro",
  
  // ============ COMBOS ============
  "-economica-garantizada", "-mejor-precio",
] as const;

export type Modifier = typeof MODIFIERS[number];

// =============================================================================
// SITUACIONES/NECESIDADES POR SERVICIO
// =============================================================================
export const PROBLEMS: Record<Service, readonly string[]> = {
  "clinica-fertilidad": [
    "no-puedo-quedarme-embarazada", "infertilidad", "abortos-repeticion",
    "baja-reserva-ovarica", "endometriosis", "ovarios-poliquisticos",
  ],
  "fecundacion-in-vitro": [
    "fiv-fallida", "segundo-intento-fiv", "embriones-congelados",
    "fiv-icsi", "diagnostico-genetico",
  ],
  "inseminacion-artificial": [
    "primera-opcion", "semen-donante", "inseminacion-conyugal",
    "baja-movilidad-esperma",
  ],
  "donacion-ovulos": [
    "menopausia-precoz", "fallo-ovarico", "mayores-40",
    "ovulos-propios-no-funcionan",
  ],
  "congelacion-ovulos": [
    "preservar-fertilidad", "tratamiento-cancer", "retrasar-maternidad",
    "vitrificacion",
  ],
  "tratamiento-fertilidad": [
    "llevar-tiempo-buscando", "problemas-concebir", "estudios-fertilidad",
  ],
  "ovodonacion": [
    "receptora-ovulos", "busco-donante", "lista-espera",
  ],
  "banco-semen": [
    "madre-soltera", "pareja-lesbiana", "donante-anonimo",
  ],
  "fertilidad-masculina": [
    "azoospermia", "varicocele", "baja-calidad-esperma",
  ],
  "reproduccion-asistida": [
    "tecnicas-reproduccion", "ayuda-embarazo", "especialista-fertilidad",
  ],
} as const;
